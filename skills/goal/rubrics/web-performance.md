...
## Rubric
- [ ] Baseline recorded as results.tsv row 1 with run-to-run variance noted — check: `head -2 results.tsv`
...
- [ ] All experiments journaled with commit hashes, including discards — check: `cat results.tsv`
