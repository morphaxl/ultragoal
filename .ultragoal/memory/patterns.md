...
- Write rubric check-phrases as literal grep strings and put that exact string in the artifact — a paraphrased heading ("setup answers" vs "knobs") makes a check unfalsifiable by grep and forces the verifier to judge substance. [VERIFIED S3 · verifier flagged the near-miss · 2026-06-10]
